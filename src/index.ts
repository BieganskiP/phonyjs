...
export { validatePT } from "./validators/pt";
export { validateSE } from "./validators/se";
export { validateNO } from "./validators/no";
export { validateUA } from "./validators/ua";
export { validateBG } from "./validators/bg";
export { validateSK } from "./validators/sk";
export { validateSI } from "./validators/si";
export { validateEE } from "./validators/ee";
export { validateLV } from "./validators/lv";
export { validateLT } from "./validators/lt";
export { validateLU } from "./validators/lu";
export { validateMT } from "./validators/mt";
export { validateIS } from "./validators/is";
export { validateRS } from "./validators/rs";
export { validateBY } from "./validators/by";
export { validateMD } from "./validators/md";
export { validateMK } from "./validators/mk";
export { validateAZ } from "./validators/az";
export { validateMC } from "./validators/mc";
export { validateLI } from "./validators/li";
export { validateSM } from "./validators/sm";
export { validateAD } from "./validators/ad";
export { validateVA } from "./validators/va";
export { validateXK } from "./validators/xk";
export { validateKZ } from "./validators/kz";
export { validateIR } from "./validators/ir";
export { validateIL } from "./validators/il";
export { validatePS } from "./validators/ps";
export { validateSY } from "./validators/sy";
